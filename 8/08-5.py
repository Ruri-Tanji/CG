...
def draw_vortisity():
    ...
    for i in range(0, N):
        ...
        for j in range(0, N):
            y = (j - 0.5) * h
            d00 = (v[i+1, j] - v[i, j] - u[i, j+1] +u[i, j]) / h
            d01 = (v[i+1, j+1] - v[i, j+1] - u[i, j+2] +u[i, j+1]) / h
            d10 = (v[i+2, j] - v[i+1, j] - u[i+1, j+1] +u[i+1, j]) / h
            d11 = (v[i+2, j+1] - v[i+1, j+1] - u[i+1, j+2] +u[i+1, j+1]) / h

            if d00 > 0:
                glColor3f(0.0, 0.0, d00/2)
            else:
                glColor3f(-d00/2, 0.0, 0.0)
            glVertex2f(x, y)
            if d10 > 0:
                glColor3f(0.0, 0.0, d10/2)
            else:
                glColor3f(-d10/2, 0.0, 0.0)
            glVertex2f(x+h, y)
            if d11 > 0:
                glColor3f(0.0, 0.0, d11/2)
            else:
                glColor3f(-d11/2, 0.0, 0.0)
            glVertex2f(x+h, y+h)
            if d01 > 0:
                glColor3f(0.0, 0.0, d01/2)
            else:
                glColor3f(-d01/2, 0.0, 0.0)
            glVertex2f(x, y+h)
    glEnd()
