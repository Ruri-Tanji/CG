...
class Particles:
    ...
    def draw(self):
        ...
        if self.temp > g_EnvTemp and self.lifetime > 0:
            ...
            glBegin(GL_POINTS)
            if(self.temp<2000000):
                glColor4f(1.0, 0.345, 0.101, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
            if(2000000<self.temp<10000000000000):
                glColor4f(0.5, 0.3, 0.4, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
            if(10000000000000<self.temp<(1e+17)):
                glColor4f(1.0, 0.3, 1.0, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
            if((1e+17)<self.temp<(1e+30)):
                glColor4f(0.3, 0.345, 0.101, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
            if((1e+17)<self.temp<(1e+45)):
                glColor4f(0.4, 1.0, 0.201, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
            if((1e+17)<self.temp<(1e+53)):
                glColor4f(0.5, 0.345, 1.0, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
            if((1e+17)<self.temp<(1e+60)):
                glColor4f(0.1, 0.345, 0.101, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
            if((1e+60)<self.temp):
                glColor4f(0.6, 0.75, 0.701, (self.temp - g_EnvTemp)/(4*g_EnvTemp))
