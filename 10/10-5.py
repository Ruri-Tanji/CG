...
# Read two images
A = cv2.imread(os.path.dirname(os.path.abspath(__file__))+"/b.png",0)
B = cv2.imread(os.path.dirname(os.path.abspath(__file__))+"/a.jpeg",0)
mask = cv2.imread(os.path.dirname(os.path.abspath(__file__))+"/mask.jpg",0)
...
if k == ord('q'):     # When the Q key is pressed, it's done.
    cv2.imwrite(os.path.dirname(os.path.abspath(__file__))+"/10-5.bmp", result)
